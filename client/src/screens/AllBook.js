...
import {getAllBook,filterBook, filterBookByAuthor} from "../actions/book_action"
           ...
           : (
               <>
                  ...
                  <button  onClick={() => dispatch(filterBook(searchKey))} className="btn btn-primary">Search  </button>
                   ...
                   <br></br>
                  <div className="col-md-8 m-auto" style={{display:"flex"}}>
                  <input type="text"  className="form-control" placeholder="search book by author"  style
                  ={{height:"50px"}}
                  onChange={(e) => setSearchKeyByAuthor(e.target.value)} value={searchKeyByAuthor} />
